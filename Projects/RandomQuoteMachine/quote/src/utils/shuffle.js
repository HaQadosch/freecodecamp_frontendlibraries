 ...
 * @since 0.1.0
 * @public
 * @param {Array<*>} source - Original array of elements to be shuffled
 * @returns {Array<*>} A new array of same length with the elements in random order
 * @example
 *
 * shuffle([1, 2, 3, 4, 5])
 * // => [3, 5. 4, 1, 2]
...
export function shuffle (source) {
  ...
  return _source.reduce((acc, cur, ind, arr) => {
