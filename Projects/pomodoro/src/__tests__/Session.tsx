...
describe('<Session />', () => {
  ...
  it('should have the attribute id="session-label"', () => {
    const { container } = render(<Session sessionDuration={ _25minutes } setSessionDuration={ () => { } } />)
  ...
  it('should display the text "Session Length"', () => {
    const { getByText } = render(<Session sessionDuration={ _25minutes } setSessionDuration={ () => { } } />)
...
describe('<SessionLength />', () => {
  ...
  it('should display the number 25 by default', () => {
    ...
    expect(elt).toHaveTextContent('25')
  })
